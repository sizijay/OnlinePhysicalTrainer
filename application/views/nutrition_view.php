     ...
     <link rel="stylesheet" href="<?php echo base_url();?>/css/style1.css" type="text/css" media="all" />
     <link rel="stylesheet" href="<?php echo base_url();?>/css/font-awesome.css" type="text/css" media="all" />
     <link rel="stylesheet" href="<?php echo base_url();?>/css/slider.css" type="text/css" media="all" />
     <link rel="stylesheet" href="<?php echo base_url();?>/elastislide.css" type="text/css" media="all" />
