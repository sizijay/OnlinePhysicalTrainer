  ...
  <div class="banner-dott">
        ...
        <div class="w3layouts_main_grid">
          <form action="#" method="post" class="w3_form_post">
            ...
            <div class="w3_agileits_main_grid w3l_main_grid">
              <span class="agileits_grid">
                <label>Age </label>
                <input type="text" id= "age" name="Task" placeholder="Age" required="">
              </span>
            </div>
            <div class="w3_agileits_main_grid w3l_main_grid">
              <span class="agileits_grid">
                <label>Email </label>
                <input type="text" id= "email" name="Task" placeholder="Email" required="">
              </span>
            </div>
            <div class="w3_agileits_main_grid w3l_main_grid">
              <span class="agileits_grid">
                <label>Phone Number </label>
                <input type="text" id= "phoneNumber" name="Task" placeholder="Phone Number" required="">
                </span>
            </div>
            ...
            <div class="w3_agileits_main_grid w3l_main_grid">
              <span class="agileits_grid">
                <label>Address </label>
                <input type="text" id= "address" name="Task" placeholder="Address" required="">
                </span>
            </div>
            ...
            <div class="w3_agileits_main_grid w3l_main_grid">
              <span class="agileits_grid">
                <label>Height </label>
                <input type="text" id= "height" name="Task" placeholder="Height" required="">
                </span>
            </div>
            ...
            <div class="w3_agileits_main_grid w3l_main_grid">
              <span class="agileits_grid">
                <label>Weight </label>
                <input type="text" id= "weight" name="Task" placeholder="Weight" required="">
                </span>
            </div>
            ...
            <div class="w3_agileits_main_grid w3l_main_grid">
              <span class="agileits_grid">
                <label>Reg No </label>
                <input type="text" id= "weight" name="Task" placeholder="Reg No" required="">
                </span>
            </div>
    ...
    <!-- //Calendar -->
      <div class="w3layouts_copy_right">
        <div class="container">
          <p>© 2017 UoC Gym Registration Form. All rights reserved | Design by UCSC</p>
        </div>
      </div>
    </div>
  </div>
